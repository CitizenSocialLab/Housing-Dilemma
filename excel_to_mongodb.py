...
def regenerate_translations(*args, **kwargs):
    ...
    filename = os.path.join(os.path.dirname(os.path.abspath(__file__)),
                            "game/i18n/translations_"+experiment+".xlsx") if "filename" not in kwargs else kwargs["filename"]
...
regenerate_translations(save=True, debug=False, clean_db=True, experiment=sys.argv[1])